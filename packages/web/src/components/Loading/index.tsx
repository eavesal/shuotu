...
export default function Loading({ type, apperance = 'orange', className }: LoadingProps) {
  return (
    <div className={cx(styles.loading, styles[type], styles[apperance], className)}>
      <div className={cx(styles.circle, styles.circle1)} />
      <div className={cx(styles.circle, styles.circle2)} />
      <div className={cx(styles.dot, styles.dot1)} />
      <div className={cx(styles.dot, styles.dot2)} />
      <div className={cx(styles.dot, styles.dot3)} />
      <div className={cx(styles.dot, styles.dot4)} />
    </div>
  )
}
